...
import { CombatAIComponent, UNIT_COMBAT_FLAG_ARMORED, UNIT_COMBAT_FLAG_BUILDING, UNIT_COMBAT_FLAG_FIRE_IMM, UNIT_COMBAT_FLAG_MACHINE } from "../../Components/CombatAIComponent";
