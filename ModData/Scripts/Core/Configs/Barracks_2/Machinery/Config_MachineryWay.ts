...
export class Config_MachineryWay extends Config_EmptyWay {
    public static CfgUid      : string = "#CastleFight_MachineryWay";
    ...
    public static InitConfig() {
        ...
        // имя
        ScriptUtils.SetValue(config, "Name", "Башня пути машин");
        // описание
        ScriptUtils.SetValue(config, "Description", "Открывает технологии машин");
        // меняем цвет
