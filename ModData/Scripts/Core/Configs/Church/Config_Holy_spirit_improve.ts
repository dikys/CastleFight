...
export class Config_Holy_spirit_improve extends IConfig {
    public static CfgUid      : string = "#CastleFight_Holy_spirit_improve";
    ...
    public static InitEntity() {
        ...
        this.Entity.components.set(COMPONENT_TYPE.BUFF_COMPONENT, new BuffComponent(BUFF_TYPE.IMPROVE));
    }
